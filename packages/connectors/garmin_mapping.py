...
COMPLETED_ACTIVITY_MAPPING: Final[tuple[GarminFieldMapping, ...]] = (
    GarminFieldMapping(
        "activityId", "provider activity identity", None, None, "external_activity_id", MAPPING_VERSION
    ),
    GarminFieldMapping(
        "activityType", "provider activity type", None, None, "activity_type_candidate", MAPPING_VERSION
    ),
    GarminFieldMapping(
        "startTimeInSeconds",
        "activity start",
